...
<div class="w3-bar w3-pale-red">
      <a href="index.php" class="w3-bar-item w3-button w3-hover-pink"></i>หน้าแรก</a>
...
<div class="w3-card-4" style="max-width:800px;background-color:#FFBE7D;margin:auto;margin-top:100px;">
  ...
  <div class="w3-row">
    <div class="w3-half w3-container">
      ...
      <p><b><?php echo $row_showproduct['product_name']; ?></b> <br><b><?php echo $row_showproduct['product_price']; ?> บาท</b></p>
    </div>
    <div class="w3-half w3-container" style="background-color:#FFBE7D;">
      <b>รายละเอียดสินค้า:</b><p><?php echo $row_showproduct['product_detail']; ?>
</p>
     

     
     
      <a href="guestpro.php" class="w3-button w3-margin w3-red w3-border w3-round-large w3-hover-black">Cancel</a>
