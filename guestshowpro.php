...
<div class="w3-col l3 s6 w3-center">
        ...
        <img class="w3-margin" src="img/<?php echo $row_showproduct['product_pic']; ?>" width="90%" /><br>
        <?php echo $row_showproduct['product_name']; ?><br>
        <b>ราคา <?php echo  $row_showproduct['product_price']; ?>บาท </b><br>
        <a href="guestdetail.php?product_id=<?php echo $row_showproduct['product_id'];?>" class="w3-button w3-green w3-border w3-round-large w3-hover-black w3-margin" ">Detail</a>
