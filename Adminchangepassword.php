...
<div class="w3-card-4 w3-padding" style="max-width:800px;background-color:#FFBE7D;margin:auto;margin-top:100px;">
  ...
  <form action="updatepass.php" method="post">
      ...
      Password:<br>
      <input type="password" name="password" id="myInput" class="w3-input w3-round-xlarge w3-border w3-margin" style="max-width:400px" value="<?php echo $row['password'];?>">
      <input type="checkbox" onclick="myFunction()">Show Password<br>

      <input type="submit" value="Update" name="update" class="w3-margin w3-button w3-blue w3-hover-black w3-round-large">
      <a href="AdminProduct.php" class="w3-button w3-red w3-hover-black w3-round-large">Cancel</a>
  </form>
</div>
<script>
function myFunction() {
